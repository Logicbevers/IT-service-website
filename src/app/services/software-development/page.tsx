...
import { ArrowRight, CheckCircle, Code2, Smartphone, Cloud, Blocks, Cpu, Database, Layers, ChevronRight } from 'lucide-react';
import { cn } from '@/lib/utils';

export const metadata: Metadata = {
    title: 'Custom Software Development | NRT Groups',
    description: 'Build custom software tailored to your business goals. Enterprise tools, automation systems, mobile apps, and scalable solutions designed for long-term success.',
};
    ...
    return (
        <div className="min-h-screen bg-background">
            <PageBanner
                ...
                title="Software That Drives Real Innovation"
                subtitle="We build custom solutions engineered for performance, scalability, and long-term value—from enterprise tools to mobile apps."
            />

            {/* Expertise Section */}
            <Section id="expertise" className="bg-muted/30" animate>
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <Heading level={2} className="mb-6 text-4xl md:text-5xl animate-fade-in-up delay-100">Software Capabilities</Heading>
                    <p className="text-muted-foreground text-lg animate-fade-in-up delay-200">
                        Comprehensive development services to transform your business vision into powerful digital solutions.
                    </p>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: "ERP systems, CRM platforms, and workflow automation built for scale."
                        },
                        {
                            icon: Cpu,
                            title: "Process Automation",
                            desc: "Automate repetitive tasks and increase operational efficiency."
                        },
                        {
                            icon: Smartphone,
                            title: "Web & Mobile Apps",
                            desc: "High-performance, responsive applications built for usability and speed."
                        },
                        {
                            icon: Layers,
                            title: "System Integration",
                            desc: "Connect data sources and build seamless digital ecosystems."
                        },
                        {
                            icon: Cloud,
                            title: "Cloud-Ready Dev",
                            desc: "Scalable, secure software that runs on AWS, Azure, or Google Cloud."
                        }
                    ].map((item, idx) => (
                        <div
                            key={idx}
            ...
            <Section className="bg-white overflow-hidden" animate>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="relative animate-float delay-200">
                        <div className="absolute inset-0 bg-gradient-to-bl from-accent/20 to-primary/5 rounded-[2rem] transform -rotate-2" />
                        <div className="relative bg-card p-10 rounded-[2rem] border border-border shadow-2xl">
                            ...
                            <div className="space-y-6">
                                {[
                                    { category: 'Frontend', techs: 'React, Angular, Vue, Next.js' },
                                    { category: 'Backend', techs: 'Node.js, Python, .NET, Java' },
                                    { category: 'Mobile', techs: 'Flutter, React Native, iOS, Android' },
                                    { category: 'Cloud', techs: 'AWS, Azure, Google Cloud' },
                                    { category: 'Databases', techs: 'PostgreSQL, MongoDB, Redis' }
                                ].map((stack, idx) => (
                                    <div key={idx} className="group">
                                        <h4 className="text-sm font-bold text-accent uppercase tracking-wider mb-2 group-hover:text-primary-dark transition-colors">{stack.category}</h4>
                                        <p className="text-lg font-medium text-foreground/80 border-b border-border pb-2 group-hover:border-accent/50 transition-colors">
                                            {stack.techs}
                                        </p>
                                    </div>
                                ))}
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <div className="max-w-3xl mx-auto animate-fade-in-up">
                        ...
                        <p className="text-xl text-white/90 mb-10 leading-relaxed">
                            Let's turn your idea into a scalable software solution that drives real business value.
                        </p>
                        <Link
                            href="/contact"
                            className={cn(
