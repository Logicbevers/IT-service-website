...
import { ArrowRight, CheckCircle, Package, TruckIcon, Warehouse, BarChart3, MapPin, ChevronRight } from 'lucide-react';
import { cn } from '@/lib/utils';

export const metadata: Metadata = {
    title: 'Logistics & Supply Chain Services | NRT Groups',
    description: 'Optimize your supply chain with cutting-edge technology and expert management.',
};
    ...
    return (
        <div className="min-h-screen bg-background">
            <PageBanner
                ...
                subtitle="Optimize your supply chain with cutting-edge technology and expert management"
            />

            {/* Core Capabilities */}
            <Section id="capabilities" className="bg-muted/30" animate>
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <div className="inline-flex items-center gap-2 mb-4 animate-fade-in-up">
                        <span className="w-8 h-1 bg-accent rounded-full"></span>
                        <span className="text-sm text-accent font-bold uppercase tracking-wider">What We Offer</span>
                    </div>
                    <Heading level={2} className="mb-6 text-4xl md:text-5xl animate-fade-in-up delay-100">Core Capabilities</Heading>
                    <p className="text-muted-foreground text-lg animate-fade-in-up delay-200">
                        Comprehensive logistics solutions designed to optimize every aspect of your supply chain.
                    </p>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: "Manage every link from procurement to final delivery ensuring seamless flow."
                        },
                        {
                            icon: BarChart3,
                            title: "Process Optimization",
                            desc: "Eliminate bottlenecks through automation and best-practice frameworks."
                        },
                        {
                            icon: MapPin,
                            title: "Real-Time Tracking",
                            desc: "Full visibility tools so you always know where your products stand."
                        },
                        {
                            icon: Warehouse,
                            title: "Warehouse Optimization",
                            desc: "Control stock movement, minimize shrinkage, and speed up processing."
                        },
                        {
                            icon: TruckIcon,
                            title: "Freight & Distribution",
                            desc: "Efficient routing, load planning, and safe on-time deliveries."
                        }
                    ].map((item, idx) => (
                        <div
                            key={idx}
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <div className="max-w-3xl mx-auto animate-fade-in-up">
                        ...
                        <p className="text-xl text-white/90 mb-10 leading-relaxed">
                            Contact us to optimize your entire supply chain and drive operational excellence.
                        </p>
                        <Link
                            href="/contact"
                            className={cn(
